...
def plot_specgram(ax, fn):
    sample_rate, X = scipy.io.wavfile.read(fn)
    ax.specgram(X[:,0], Fs=sample_rate, xextent=(0, 30))
...
if __name__ == "__main__":
    #for fn in Path(r"C:/Users/Rag9704/Pictures/genres1").glob("**/*.wav"):
     #   create_fft(fn)

    # plot_decomp()
    # for fn in os.listdir(r"C:/Users/Rag9704/Pictures/genres1/blues"):
     #      create_fft(fn)
